...
```{r fig.align='center'}
kable(read.csv("model_accuracies.csv"),
...
By using Ridge we are able to select  features, but the 
cross-validation accuracy reduces to about 0.27.


```{r fig.align='center'}
kable(read.csv("rf_result_with_feature_selection.csv"),
...
```{r fig.align='center'}
kable(read.csv("best_params.csv"),
...
```{r fig.align='center'}
kable(read.csv("validation_score.csv"),
