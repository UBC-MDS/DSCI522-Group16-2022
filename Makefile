...
survey_results_public.csv survey_results_schema.csv README_2022.txt so_survey_2022.pdf : src/data_download.py
	python src/data_download.py --url='https://info.stackoverflowsolutions.com/rs/719-EMH-566/images/stack-overflow-developer-survey-2022.zip' --out_file='data/raw' survey_results_public.csv
...
filtered_data.csv train.csv test.csv train_encoded.csv test_encoded.csv : src/data_preprocessing.py survey_results_public.csv
	python src/data_preprocessing.py --data_input='data/raw/survey_results_public.csv' --data_output_path='data/processed/' filtered_data.csv train.csv test.csv train_encoded.csv test_encoded.csv
