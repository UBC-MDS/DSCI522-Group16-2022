...
data/processed/filtered_data.csv data/processed/train.csv data/processed/test.csv data/processed/train_encoded.csv data/processed/ttest_encoded.csv: src/data_preprocessing.py
...
<output file form eds script, Tanmay>: src/data_model_selection_analysis.py
...
# render final report
doc/breast_cancer_predict_report.md: documents/FinalReport.Rmd references.bib
