...
python data_eda.py --data_input='../data/processed/train.csv' -file-out-path='../documents/' 
...
python data_model_selection_analysis.py --data_train='../data/processed/train_encoded.csv' --data_test='../data/processed/test.csv' -file-out-path='../documents/'